========================================================================
    DYNAMIC LINK LIBRARY: IvmpDotNetWrapper-Projektübersicht
========================================================================

Diese IvmpDotNetWrapper-DLL wurde vom Anwendungs-Assistenten für Sie 
erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre IvmpDotNetWrapper-Anwendung besteht.

IvmpDotNetWrapper.vcxproj
...
IvmpDotNetWrapper.vcxproj.filters
